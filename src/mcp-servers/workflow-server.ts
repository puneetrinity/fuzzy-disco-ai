...
export class WorkflowMCPServer {
  ...
  private async handleStyleSelection(args: any) {
  ...
  private async handleTeamCoordination(args: any) {
  ...
  private async handleCodeAnalysis(args: any) {
  ...
  private async handleRefactoringSuggestion(args: any) {
