...
export interface StyleRecommendation {
  practitioner: 'fowler' | 'uncle-bob' | 'kent-beck' | 'jessica-kerr' | 'kelsey';
  rationale: string;
...
export class PractitionerStyleSelector {
  private styleRules: Map<string, StyleRecommendation> = new Map();
  ...
  async selectOptimalStyle(context: TaskContext): Promise<StyleRecommendation> {
  ...
  private buildPrimaryKey(context: TaskContext): string {
  ...
  private selectByTaskType(context: TaskContext): StyleRecommendation {
  ...
  private adjustForContext(recommendation: StyleRecommendation, context: TaskContext): StyleRecommendation {
  ...
  getStyleGuide(practitioner: string): string {
    ...
    return guides[practitioner as keyof typeof guides] || 'Unknown practitioner';
  }
}
